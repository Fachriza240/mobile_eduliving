...
class ActivityListScreen extends StatefulWidget {
  final int? initialId;
  const ActivityListScreen({super.key, this.initialId});
...
class _ActivityListScreenState
    extends State<ActivityListScreen>
      ...
      builder: (_, prov, __) => Container(
        ...
        child : ListView.builder(
          ...
          itemBuilder: (_, i) => FilterChipWidget(
            ...
            isSelected   : prov.selectedCategory ==
                _categories[i]['id'],
            onTap        : () => prov
                .setCategory(_categories[i]['id']!),
      ...
      builder: (_, prov, __) {
        ...
        if (prov.error != null &&
          ...
          return ErrorState(
            message: prov.error!,
            onRetry: () =>
                prov.loadActivities(refresh: true),
          );
        }
...
class _ActivityCard extends StatelessWidget {
  ...
  final double price;
  final int slots;
  final bool isFree, isAvailable, isPassed,
      isDeadlinePassed;
            ...
            Stack(children: [
              ...
              if (isFree)
                Positioned(
                  top: 12, right: 12,
                  child: _badge('GRATIS',
                      AppColors.activity, Colors.white),
                ),
              if (isPassed)
                Positioned.fill(
                  child: Container(
