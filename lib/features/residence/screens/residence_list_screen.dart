...
class ResidenceListScreen extends StatefulWidget {
  final int? initialId;
  const ResidenceListScreen({super.key, this.initialId});
...
class _ResidenceListScreenState extends State<ResidenceListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      // Jika ada initialId langsung buka detail
      if (widget.initialId != null) {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => ResidenceDetailScreen(id: widget.initialId!),
          ),
        );
      }
    });
      ...
      builder: (_, prov, __) {
        if (prov.isLoading) {
          return ListView.builder(
            ...
            itemCount: 5,
            itemBuilder: (_, __) => const _SkelCard(),
          );
        }
        ...
        if (prov.residences.isEmpty) {
          return EmptyState(
            message: 'Tidak ada hunian ditemukan.\nCoba ubah filter.',
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            formatRupiah(price, suffix: '/$period'),
                            style: const TextStyle(
                              fontFamily: 'Poppins',
                              fontSize: 16,
                              fontWeight: FontWeight.w700,
