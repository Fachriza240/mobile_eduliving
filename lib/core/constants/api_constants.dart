class ApiConstants {
  ...
  static String userBookingPayment(int id) => '/user/bookings/$id/payment-proof';
  ...
  // Semua endpoint seller ada di bawah /user/seller/
  // sesuai routes/api.php → Route::prefix('seller')
  static const String becomeProviderMarketplace = '/user/seller/activate';
  static const String sellerStatus              = '/user/seller/status';
  static const String sellerHome                = '/user/seller/home';

  // Produk seller
  static const String providerMarketplaceProducts         = '/user/seller/products';
  static String providerMarketplaceProductUpdate(int id)  => '/user/seller/products/$id';
  static String providerMarketplaceProductDelete(int id)  => '/user/seller/products/$id';
  // Backend tidak punya toggle-status terpisah, pakai update dengan status field
  static String providerMarketplaceProductToggle(int id)  => '/user/seller/products/$id';

  // Pesanan seller — backend hanya punya satu endpoint update status:
  // PATCH /user/seller/orders/{id}/status  dengan body { status: '...' }
  static const String providerMarketplaceOrders               = '/user/seller/orders';
  static String providerMarketplaceOrderDetail(int id)        => '/user/seller/orders/$id';
  static String providerMarketplaceOrderUpdateStatus(int id)  => '/user/seller/orders/$id/status';

  // Helper shortcut agar provider lama tetap compile
  static String providerMarketplaceOrderConfirm(int id)   => '/user/seller/orders/$id/status';
  static String providerMarketplaceOrderShip(int id)      => '/user/seller/orders/$id/status';
  static String providerMarketplaceOrderComplete(int id)  => '/user/seller/orders/$id/status';
  static String providerMarketplaceOrderReject(int id)    => '/user/seller/orders/$id/status';
  ...
  static String userTransactionCancel(int id)  => '/user/transactions/$id/cancel';
  static String userTransactionPayment(int id) => '/user/transactions/$id/payment-proof';
