...
//static const String providerResidenceReport = '/provider/residence/report';
//static const String providerEventReport     = '/provider/event/report';
  ...
  static String providerMarketplaceOrderDetail(int id) =>
      '/user/seller/orders/$id';
  static String providerMarketplaceOrderUpdateStatus(int id) =>
      '/user/seller/orders/$id/status';
